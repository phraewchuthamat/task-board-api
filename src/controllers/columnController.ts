...
export const getColumns = async (req: AuthRequest, res: Response): Promise<any> => {
    try {
...
// 2. สร้าง Column ใหม่
export const createColumn = async (req: AuthRequest, res: Response): Promise<any> => {
    try {
...
export const updateColumn = async (req: AuthRequest, res: Response): Promise<any> => {
    try {
...
// 4. ลบ Column
export const deleteColumn = async (req: AuthRequest, res: Response): Promise<any> => {
    try {
        const { id } = req.params as { id: string };
        const userId = req.user?.userId;
